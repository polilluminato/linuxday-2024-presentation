...
class ScatterChartSample extends StatefulWidget {
  ScatterChartSample({super.key});

  final blue1 = Colors.blue.withOpacity(0.5);
  final blue2 = Colors.blue;

  @override
  State<StatefulWidget> createState() => ScatterChartSampleState();
}

class ScatterChartSampleState extends State<ScatterChartSample> {
  final maxX = 50.0;
  final maxY = 50.0;
  final radius = 8.0;
